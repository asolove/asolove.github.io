...
<figure>
  <img class="full" src="/img/pure-ui-control/pure-ui-control-b7baa454.png" alt="Desktop UI calculator with number and operation buttons and a display for values.">
</figure>
